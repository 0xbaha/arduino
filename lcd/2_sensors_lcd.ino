...
void read_sensor_ultrasonic(){
  ...
  lcd.setCursor(0,0);					    // atur posisi kursor (kolom 0,baris 0)
  lcd.print("Jarak ");
  lcd.setCursor(6,0);					    // atur posisi kursor (kolom 6,baris 0)
  lcd.print(cm);
...
void read_sensor_temperature(){
  ...
  lcd.setCursor(0,1);					    // atur posisi kursor (kolom 0,baris 1)
  lcd.print("Suhu ");
  lcd.setCursor(6,1);					    // atur posisi kursor (kolom 6,baris 1)
  lcd.print(TMP_value);
